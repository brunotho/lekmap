------------------------------------------------------------------------------
--	ChunkIsland.lua (recreated from transcript)
--	6-9 tiles, compact, square-ish (ratio 1:1 to 1:1.5). Hills 50-60%, mountains by size.
------------------------------------------------------------------------------
...
function TryPlaceChunkIsland(plotTypes, centerX, centerY, islLandInRing, params)
	...
	DrawChunkIsland(plotTypes, landTiles, params.iW);
	return true;
end

function DrawChunkIsland(plotTypes, landTiles, iW)
