------------------------------------------------------------------------------
--	PebbleIsland.lua (recreated from transcript)
--	3-4 tiles, compact blob, roughly circular. Hills 50-60%, mountains by size.
------------------------------------------------------------------------------
...
function TryPlacePebbleIsland(plotTypes, centerX, centerY, islLandInRing, params)
	...
	DrawPebbleIsland(plotTypes, landTiles, params.iW);
	return true;
end

function DrawPebbleIsland(plotTypes, landTiles, iW)
