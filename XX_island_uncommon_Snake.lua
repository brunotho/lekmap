-- Long S-curved island, usually plain hills and land, sometimes a wider head or a mid-body mountain cluster.
...
function TryPlaceSnakeIsland(plotTypes, centerX, centerY, islLandInRing, params)
	...
	DrawSnakeIsland(plotTypes, landTiles, hasHead, hasMountainCluster, params.iW, params.iH, params.wrapX, params.wrapY);
	return true;
end
