------------------------------------------------------------------------------
--	VolcanicRing.lua
--	Central mountain(s), r1 water ring. Scattered islands at r2+r3 with gaps.
------------------------------------------------------------------------------
...
local CONFIG = {
	DISK_RADIUS = 3,
	WATER_RING_RADIUS = 1,
	NUM_ISLANDS_MIN = 1, NUM_ISLANDS_MAX = 5,  -- 1 = near-full ring, 4-5 = scattered
	ONE_ISLAND_RING_PCT_MIN = 80, ONE_ISLAND_RING_PCT_MAX = 95,  -- when 1 island: % of ring that is land
	-- when 1 island: gaps are distributed randomly (not contiguous)
	...
	R3_LAND_MAX_PCT = 65,  -- max % of r3 tiles that can be land (avoids 3 thick rings)
	BAY_INLET_PCT = 22,  -- % of r3 island tiles to convert to water (small bays cutting in)
	OUTER_RING_PCT = 6,  -- very rare: add 1-3 land tiles at r4
