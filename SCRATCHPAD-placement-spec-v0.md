...
**Child subspec (diagnostics — proposed logs, not implemented yet):** [`SCRATCHPAD-placement-subspec-tuple-pool-diagnostics-v0.md`](./SCRATCHPAD-placement-subspec-tuple-pool-diagnostics-v0.md) (includes **D8 bias/ripple snapshot**, **Appendix A** roll digests).
