...
local CONFIG = {
	...
	SPLINTERED_RIDGE_PCT = 30,
	SPLINTERED_RIDGE_WIDTH_MIN = 4, SPLINTERED_RIDGE_WIDTH_MAX = 6,
	SPLINTERED_GAP_COUNT_MIN = 6, SPLINTERED_GAP_COUNT_MAX = 14,
	SPLINTERED_GAP_2_TILE_PCT = 25,
	RIDGE_THIN_EXPAND_ROWS = 2,
	RIDGE_THIN_EXPAND_PCT = 85,
	RIDGE_THIN_FORCE_AT = 5,
	ARM_STRAIGHT_FORCE_AT = 5,

	ARCTIC_FILL_EDGE_EXTEND_ROWS = 2,
	ARCTIC_FILL_8_ROW_PCT = 50,
	ARCTIC_FILL_8_ROW_DEPTH_MIN = 6, ARCTIC_FILL_8_ROW_DEPTH_MAX = 8,
	ARCTIC_FILL_DEPTH_MIN = 1, ARCTIC_FILL_DEPTH_MAX = 5,
	ARCTIC_FILL_EXTENDED_MAP_PCT = 20,
	ARCTIC_FILL_EXTENDED_BAND_FRAC = 0.12,
	ARCTIC_FILL_TILE_PCT = 42,
	ARCTIC_FILL_TILE_PCT_ROW_VAR = 18,
	ARCTIC_FILL_TILE_PCT_NEAR_EDGE = 78,
	ARCTIC_FILL_ADJACENT_PCT = 88,
	ARCTIC_FILL_ISOLATED_PCT = 12,
	ARCTIC_FILL_HILLS_PCT = 45,
	ARCTIC_FILL_HILLS_ROW_VAR = 20,
	ARCTIC_RIDGE_PCT = 35,
	ARCTIC_RIDGE_WIDTH_MIN = 3, ARCTIC_RIDGE_WIDTH_MAX = 6,

	GAP_POLICY = "always",
	GAP_OPTIONAL_PCT = 60,
	GAP_COUNT_MIN = 1, GAP_COUNT_MAX = 3,
	GAP_THICKNESS_MIN = 1, GAP_THICKNESS_MAX = 4,
	GAP_CUT_FULL_WIDTH = true,
	GAP_SPLINTER_PCT = 100,
	GAP_SPLINTER_STEP_PCT = 35,
	GAP_DIST_FROM_EDGE_MIN = 6, GAP_DIST_FROM_EDGE_MAX = 12,

	EXTENDED_INLAND_PCT = 10,
	EXTENDED_INLAND_DEPTH_BONUS_MIN = 4, EXTENDED_INLAND_DEPTH_BONUS_MAX = 8,
	EXTENDED_INLAND_WIDTH_MAX = 8,
	EXTENDED_INLAND_TILE_PCT = 28,
	EXTENDED_INLAND_MTN_PCT = 28, EXTENDED_INLAND_LAKE_PCT = 42,
};
