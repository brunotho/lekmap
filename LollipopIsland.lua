------------------------------------------------------------------------------
--	LollipopIsland.lua
--	10-14 tiles. Round base 2-3 thick, single stem 3-5 tiles, 1 tile wide.
--	Base: hills 70%, 1-2 mountains. Stem: hills 50%, no mountains.
------------------------------------------------------------------------------
...
function DrawLollipopIsland(plotTypes, landTiles, iW)
